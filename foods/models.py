...
class Food(models.Model):
    ...
    folate_mcg             = models.PositiveSmallIntegerField(default=0,  verbose_name="folate (mcg)")
    biotin_mcg             = models.PositiveSmallIntegerField(default=0,  verbose_name="biotin (mcg)")
    pantothenic_acid_B5_mg = models.PositiveSmallIntegerField(default=0,  verbose_name="pantothenic acid (mg)")
